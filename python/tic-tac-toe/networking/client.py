...
class Connect:
    ...
    def get_ip(self):
        ...
        if not self.host:
            ...
            self.host_port = raw_input("Input HOST PORT ----> ")
            self.port = raw_input("Input PORT ----> ")
...
class Game:
    ...
    def network_player_get_tile(self):

        self.message = all_sprites_group
