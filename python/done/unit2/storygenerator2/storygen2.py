'''
Elston Almeida
A story where the user chooses their own path
2016/03/20
ICS 3U1
'''
#main()
...
def win():
    clear_screen()
    print "Your enemies are so astounded by your lack of confidence\nThey decide that you are not worth the effort\nYou WIN"
